...
class Example(object):
  ...
  def __init__(self, article, abstract_sentences, abstract_sentences_all, vocab, hps, stop_words):
    ...
    if hps.pointer_gen:
      ...
      if hps.co_occurrence or hps.prev_relation or hps.co_occurrence_h or hps.co_occurrence_i or (hps.coverage and hps.coverage_weighted) or hps.attention_weighted:
        self.cooccurrence_matrix, self.cooccurrence_weight = data.get_cooccurrence_matrix(self.enc_input_extend_vocab, exclude_words=stop_words, need_weight=(hps.co_occurrence_i or (hps.coverage and hps.coverage_weighted) or hps.attention_weighted))
  ...
  def fill_batch_queue(self):
    ...
    while True:
      if self._hps.mode != 'decode':
        ...
        if self._hps.co_occurrence or self._hps.prev_relation or self._hps.co_occurrence_h or self._hps.co_occurrence_i or (self._hps.coverage and self._hps.coverage_weighted) or self._hps.attention_weighted:
